...
# read in excel file
df = pd.read_excel("../data/source/NAH inv  939 dienstboderegister 1880-1887.xlsx", 
       dtype='str', na_values='---')
...
df['aankomstDatumCl'] = df['aankomstDatumCl'].replace('10-09--1883', '10-09-1883')
...
# ok let's kill all other values
...
print( df[df['aankomstDatumCl'].notnull()] )

xx stopped continuing cleaning because of time related issues // 2022-11-18
